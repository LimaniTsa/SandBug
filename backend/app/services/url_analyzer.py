...
# Suppress the warning from verify=False in _follow_redirects.
# the scanner must follow redirects on sites with invalid certs.
...
IP_GRABBER_DOMAINS = {
    ...
    '2ip.ru', '02ip.ru', 'yip.su', 'iplis.ru',
    'ipgrab.net', 'ip-logger.org',
    'blasze.tk', 'blasze.com',
    'lovebird.guru', 'trker.eu', 'maper.info', 'datawallet.io',
    'canarytokens.com', 'canarytokens.org',
    'getnotify.com',
    'ipgrabber.ru', 'ipgrabb.er', 'api.grabify.link',
    'ezstats.xyz', 'linkz.io', 'spyip.net',
    'whatismyipaddress.com', 'ip-api.com', 'track.rs',
    'clicktracking.net', 'ipspy.net', 'freegeoip.app',
    'checkip.dyndns.org', 'iphunter.info', 'trackurl.it',
    'shortlogger.com', 'piratewings.com', 'nicelink.ru',
    'lnkshortner.xyz', 'datadome.co',
}
